 ...
 *
 */
public class LluitadorCap implements ILluitador {
     ...
     */
    public LluitadorCap(String nomBoxejador) {
		nom = nomBoxejador;
	...
	public LlocOnPicar Pica() {
		return  LlocOnPicar.Cap;    // Sempre pica al Cap 
	}
	...
	public List<LlocOnPicar> Protegeix() {
        ...
        proteccio.add(LlocOnPicar.Cap);            // Afegim la protecció al cap que sempre fa aquest lluitador de a més a més 

        copsPossibles.remove(LlocOnPicar.Cap);     // Eliminem l'opció del cap ja que sempre es protegeix al cap
